...
export function SiteHeader({ active }: { active?: 'home' | 'about' | 'achievements' | 'events' | 'team' | 'join' | 'donate' }) {
  return (
    <header className="site-header">
      ...
      <nav className="desktop-nav" aria-label="Primary navigation">
        ...
        <a className={active === 'achievements' ? 'active' : undefined} href={sitePath('/achievements')}>Results</a>
